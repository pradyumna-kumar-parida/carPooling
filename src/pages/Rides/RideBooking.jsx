      ...
      >
        <DialogContent>
          ...
          {!isVerified ? (
            <>
              ...
              {!showOtpInput && (
                <Button
                  ...
                  sx={{
                    background:
                      "linear-gradient(135deg, #1e40af 0%, #0369a1 100%)",
                    color: "white",
                    py: 1.5,
                    fontSize: "1rem",
                    fontWeight: 600,
                    ...
                    "&:hover": {
                      background:
                        "linear-gradient(135deg, #1e3a8a 0%, #075985 100%)",
                    },
                  }}
                >
                  Get OTP
              ...
              {/* OTP Input (Shows after Get OTP is clicked) */}
              {showOtpInput && (
                <>
                  <TextField
                    fullWidth
            ...
            <Stack spacing={2} sx={{ textAlign: "center", p: 3 }}>
              <Typography
                variant="h5"
