...
const PRHero = () => {
  ...
  const [selectedVehicle, setSelectedVehicle] = useState(
    saved.selectedVehicle || "",
  );
  const { vehicleList, vehiclesLoading, setVehiclesLoading } = useVehicleList();
  ...
  useEffect(() => {
    if (location.state?.savedForm) {
      showAlert(
        "info",
        "Your form data has been restored. You can now publish your ride!",
      );
